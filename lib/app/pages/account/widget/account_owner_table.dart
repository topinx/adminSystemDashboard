...
class AccountOwnerTable extends StatelessWidget {
  ...
  TableRow buildTableTitle(AccountOwnerController ctr) {
    return const TableRow(
      ...
      children: [
        TableCell(child: TableText("账号名称", true, first: true)),
  ...
  TableRow buildTableRow(AccountOwnerController ctr) {
    return TableRow(
      ...
      children: const [
        TableCell(child: TableText("40001", false, first: true)),
      ...
      child: GetBuilder<AccountOwnerController>(
        ...
        builder: (ctr) => Table(
          columnWidths: const {
            ...
            3: MaxColumnWidth(
                FixedColumnWidth(100.0), FractionColumnWidth(0.2)),
            4: MaxColumnWidth(FixedColumnWidth(80.0), FractionColumnWidth(0.1)),
